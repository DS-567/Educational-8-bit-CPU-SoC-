...
🚧 **Still Work in Progress: Core hardware is functional. Final Timer PCB and FPGA version and Python simulator under active development!**
...
| `/software`  | Python-based assembler used to assemble CPU programs *(ongoing)*. |
